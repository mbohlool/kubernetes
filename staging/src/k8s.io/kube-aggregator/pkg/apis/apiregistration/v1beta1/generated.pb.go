...
func (m *APIService) MarshalTo(dAtA []byte) (int, error) {
	...
	i += n3
	if m.DisableOpenAPIAggregation != nil {
		dAtA[i] = 0x20
		i++
		if *m.DisableOpenAPIAggregation {
			dAtA[i] = 1
		} else {
			dAtA[i] = 0
		}
...
func (this *APIService) String() string {
	...
	s := strings.Join([]string{`&APIService{`,
		...
		`DisableOpenAPIAggregation:` + valueToStringGenerated(this.DisableOpenAPIAggregation) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *APIService) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableOpenAPIAggregation", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorGenerated = []byte{
	...
	,
}
