...
func CreateMultiVersionTestCRD(f *Framework, group string, apiVersions []apiextensionsv1beta1.CustomResourceDefinitionVersion, conversionWebhook *v1beta1.WebhookClientConfig) (*TestCrd, error) {
	suffix := randomSuffix()
	...
	if conversionWebhook != nil {
		crd.Spec.Conversion = &apiextensions_v1beta1.CustomResourceConversion{
			Strategy: "Webhook",
			Webhook: &apiextensions_v1beta1.CustomResourceConversionWebhook{
