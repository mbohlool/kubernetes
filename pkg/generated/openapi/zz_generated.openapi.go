...
func GetOpenAPIDefinitions(ref openapi.ReferenceCallback) map[string]openapi.OpenAPIDefinition {
	return map[string]openapi.OpenAPIDefinition{
		...
		"k8s.io/kubernetes/pkg/api/v1.DeleteOptions": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"preconditions": {
							SchemaProps: spec.SchemaProps{
								...
								Ref:         ref("k8s.io/kubernetes/pkg/api/v1.Preconditions"),
							},
						},
						"orphanDependents": {
							SchemaProps: spec.SchemaProps{
			...
			Dependencies: []string{
				"k8s.io/kubernetes/pkg/api/v1.Preconditions"},
		},
		...
		"k8s.io/kubernetes/pkg/api/v1.HTTPGetAction": {
					...
					Properties: map[string]spec.Schema{
						...
						"port": {
							SchemaProps: spec.SchemaProps{
								...
								Ref:         ref("k8s.io/kubernetes/pkg/util/intstr.IntOrString"),
							},
						},
						"host": {
							SchemaProps: spec.SchemaProps{
			...
			Dependencies: []string{
				"k8s.io/kubernetes/pkg/api/v1.HTTPHeader", "k8s.io/kubernetes/pkg/util/intstr.IntOrString"},
		},
		...
		"k8s.io/kubernetes/pkg/api/v1.ListOptions": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
		...
		"k8s.io/kubernetes/pkg/api/v1.ServicePort": {
			...
			Dependencies: []string{
				"k8s.io/kubernetes/pkg/util/intstr.IntOrString"},
		},
		...
		"k8s.io/kubernetes/pkg/apis/certificates/v1alpha1.CertificateSigningRequest": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								...
								Ref:         ref("k8s.io/kubernetes/pkg/apis/certificates/v1alpha1.CertificateSigningRequestSpec"),
							},
						},
						"status": {
							SchemaProps: spec.SchemaProps{
								Description: "Derived information about the request.",
								Ref:         ref("k8s.io/kubernetes/pkg/apis/certificates/v1alpha1.CertificateSigningRequestStatus"),
							},
						},
					},
				},
			...
			Dependencies: []string{
				"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/kubernetes/pkg/apis/certificates/v1alpha1.CertificateSigningRequestSpec", "k8s.io/kubernetes/pkg/apis/certificates/v1alpha1.CertificateSigningRequestStatus"},
		},
		"k8s.io/kubernetes/pkg/apis/certificates/v1alpha1.CertificateSigningRequestCondition": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"type": {
		...
		"k8s.io/kubernetes/pkg/apis/certificates/v1alpha1.CertificateSigningRequestList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"kind": {
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("k8s.io/kubernetes/pkg/apis/certificates/v1alpha1.CertificateSigningRequest"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "k8s.io/kubernetes/pkg/apis/certificates/v1alpha1.CertificateSigningRequest"},
		},
		"k8s.io/kubernetes/pkg/apis/certificates/v1alpha1.CertificateSigningRequestSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
		...
		"k8s.io/kubernetes/pkg/apis/certificates/v1alpha1.CertificateSigningRequestStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"conditions": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("k8s.io/kubernetes/pkg/apis/certificates/v1alpha1.CertificateSigningRequestCondition"),
										},
									},
								},
							},
		...
		"k8s.io/kubernetes/pkg/apis/policy/v1beta1.Eviction": {
					...
					Properties: map[string]spec.Schema{
						...
						"deleteOptions": {
							SchemaProps: spec.SchemaProps{
								...
								Ref:         ref("k8s.io/kubernetes/pkg/api/v1.DeleteOptions"),
							},
						},
					},
				},
			...
			Dependencies: []string{
				"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/kubernetes/pkg/api/v1.DeleteOptions"},
		},
		...
		"k8s.io/kubernetes/pkg/apis/policy/v1beta1.PodDisruptionBudgetSpec": {
			...
			Dependencies: []string{
				"k8s.io/apimachinery/pkg/apis/meta/v1.LabelSelector", "k8s.io/kubernetes/pkg/util/intstr.IntOrString"},
		},
