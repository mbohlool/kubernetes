...
func TestAdmission(t *testing.T) {
	...
	for _, tc := range cases {
		...
		err := handler.Validate(admission.NewAttributesRecord(p, nil, api.Kind("Pod").WithVersion("version"), "foo", "name", api.Resource("pods").WithVersion("version"), "", "ignored", false, nil, nil), nil)
