...
func TestIgnoresNonPodResource(t *testing.T) {
	pod := &api.Pod{}
	attrs := admission.NewAttributesRecord(pod, nil, api.Kind("Pod").WithVersion("version"), "myns", "myname", api.Resource("CustomResource").WithVersion("version"), "", admission.Create, false, nil, nil)
...
func TestIgnoresNilObject(t *testing.T) {
	attrs := admission.NewAttributesRecord(nil, nil, api.Kind("Pod").WithVersion("version"), "myns", "myname", api.Resource("pods").WithVersion("version"), "", admission.Create, false, nil, nil)
	err := NewServiceAccount().Admit(attrs, nil)
	if err != nil {
...
func TestIgnoresNonPodObject(t *testing.T) {
	obj := &api.Namespace{}
	attrs := admission.NewAttributesRecord(obj, nil, api.Kind("Pod").WithVersion("version"), "myns", "myname", api.Resource("pods").WithVersion("version"), "", admission.Create, false, nil, nil)
	err := NewServiceAccount().Admit(attrs, nil)
	if err != nil {
...
func TestIgnoresMirrorPod(t *testing.T) {
	...
	attrs := admission.NewAttributesRecord(pod, nil, api.Kind("Pod").WithVersion("version"), "myns", "myname", api.Resource("pods").WithVersion("version"), "", admission.Create, false, nil, nil)
	err := NewServiceAccount().Admit(attrs, nil)
	if err != nil {
...
func TestAssignsDefaultServiceAccountAndToleratesMissingAPIToken(t *testing.T) {
	...
	pod := &api.Pod{}
	attrs := admission.NewAttributesRecord(pod, nil, api.Kind("Pod").WithVersion("version"), ns, "myname", api.Resource("pods").WithVersion("version"), "", admission.Create, false, nil, nil)
...
func TestAllowsReferencedSecret(t *testing.T) {
	...
	attrs := admission.NewAttributesRecord(pod1, nil, api.Kind("Pod").WithVersion("version"), ns, "myname", api.Resource("pods").WithVersion("version"), "", admission.Create, false, nil, nil)
	if err := admit.Admit(attrs, nil); err != nil {
		t.Errorf("Unexpected error: %v", err)
	}
	...
	attrs = admission.NewAttributesRecord(pod2, nil, api.Kind("Pod").WithVersion("version"), ns, "myname", api.Resource("pods").WithVersion("version"), "", admission.Create, false, nil, nil)
	if err := admit.Admit(attrs, nil); err != nil {
		t.Errorf("Unexpected error: %v", err)
	}
