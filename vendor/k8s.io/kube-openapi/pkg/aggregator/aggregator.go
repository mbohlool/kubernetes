...
// SafeMergeSpecs is differ from MergeSpecs as it assumers dest and source does not
// have any name conflicts. In case of a conflict, merging will fail.
func SafeMergeSpecs(dest, source *spec.Swagger) error {
